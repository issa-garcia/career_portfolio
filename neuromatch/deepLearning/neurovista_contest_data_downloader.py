...
def main(SEGMENT_MIN,SEGMENT_MAX,GMT_OFFSET,STUDIES,OUTPUT_PATH):  # pylint:disable=too-many-locals
...
if __name__ == '__main__':
    main(SEGMENT_MIN,SEGMENT_MAX,GMT_OFFSET,STUDIES,OUTPUT_PATH)
