...
sub_001_ICVF <- readNIfTI('C:/Users/Victor/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/AMICO_sub-001/AMICO/NODDI/FIT_dir.nii.gz', reorient = FALSE)
...
sub_005_ICVF <- readNIfTI('C:/Users/Victor/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/AMICO_sub-005/AMICO/NODDI/FIT_dir.nii.gz', reorient = FALSE)
...
for(i in 1:48) {
  ...
  sub_001_tmp <- sub_001_ICVF@.Data[,,,3]
  sub_001_tmp <- sub_001_tmp[sub_001_logind]
  sub_001_ICVF_list[[i]] <- sub_001_tmp
  sub_001_df <- data_frame(val = sub_001_ICVF_list[[i]]) %>% mutate(., sub = "sub-001")
  
  sub_005_logind <- sub_005_atlas@.Data == i
  sub_005_tmp <- sub_005_ICVF@.Data[,,,3]
  sub_005_tmp <- sub_005_tmp[sub_005_logind]
  sub_005_ICVF_list[[i]] <- sub_005_tmp
  ...
  plots_violin[[i]] <- ggplot(subs_df, aes(x=sub,y=val)) + 
    ...
    labs(x="",y = "Fiber orientation (dir z)")+
...
t_tests_tib <- dplyr::tibble(index = 1:48,
                             "WM region: Fiber orientation (dir z) between sub-001 and sub-005" = atlas_labels$V2[2:49],
                             "Mean difference" = round(delta_means,3),
                             "p-value" = p_values_rd)
gt_tbl <- gt(data = t_tests_tib, auto_align = FALSE)
gt_tbl <- cols_align(gt_tbl,
           align = "left",
           columns = "WM region: Fiber orientation (dir z) between sub-001 and sub-005")
gt_tbl


gt_tbl %>%
  gtsave("dirZ_t_tests.html", inline_css = TRUE,
         path = 'C:/Users/Victor/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_sub1VSsub5/dirZ/'
  )
...
fifth1 <- ggarrange(plots_violin[[1]],
          ...
          plots_violin[[10]],
          ncol = 5,nrow = 2)
ggsave(fifth1, file='C:/Users/Victor/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_sub1VSsub5/dirZ/dirZ_WMregions1_10.png', width = 1366/72, height = 768/72, dpi = 72)
...
fifth2 <- ggarrange(plots_violin[[11]],
          ...
          plots_violin[[20]],
          ncol = 5,nrow = 2)
ggsave(fifth2, file='C:/Users/Victor/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_sub1VSsub5/dirZ/dirZ_WMregions11_20.png', width = 1366/72, height = 768/72, dpi = 72)
...
fifth3 <- ggarrange(plots_violin[[21]],
          ...
          plots_violin[[30]],
          ncol = 5,nrow = 2)
ggsave(fifth3, file='C:/Users/Victor/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_sub1VSsub5/dirZ/dirZ_WMregions21_30.png', width = 1366/72, height = 768/72, dpi = 72)
...
fifth4 <- ggarrange(plots_violin[[31]],
          ...
          plots_violin[[40]],
          ncol = 5,nrow = 2)
ggsave(fifth4, file='C:/Users/Victor/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_sub1VSsub5/dirZ/dirZ_WMregions31_40.png', width = 1366/72, height = 768/72, dpi = 72)
...
fifth5 <- ggarrange(plots_violin[[41]],
          ...
          plots_violin[[48]],
          ncol = 4,nrow = 2)
ggsave(fifth5, file='C:/Users/Victor/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_sub1VSsub5/dirZ/dirZ_WMregions41_48.png', width = 1366/72, height = 768/72, dpi = 72)
