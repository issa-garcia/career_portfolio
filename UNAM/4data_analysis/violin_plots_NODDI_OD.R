...
subs_df <- rbind(df_Caud2Medulla,df_Caud2Palli,df_DLPFC2Caud,df_DLPFC2Thal,df_Thal2Medulla,df_Thal2Palli)
saveRDS(subs_df,file = "C:/Users/vissa/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_all/OD/meanODinROIs.RDS")


subs_df <- readRDS("C:/Users/vissa/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_all/OD/meanODinROIs.RDS")
...
subs_df <- mutate(subs_df,group=factor(group,levels = c(1,2)))
...
plots_violin <- ggplot(subs_df, aes(fill=group,x=atlas,y=val)) + 
  ...
  geom_jitter(color="black", size=0.85, alpha=1) +
  #theme_ipsum() +
  #theme(
...
plots_violin
ggsave(plots_violin, file='C:/Users/vissa/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_all/OD/OD_WMregions_shamVSactive.png', width = 1366/72, height = 768/72, dpi = 72)
...
for(k in sort(unique(subs_df$atlas))) {
  group1 <- filter(subs_df,atlas==k,group==1)
  group2 <- filter(subs_df,atlas==k,group==2)
...
gt_tbl %>%
  gtsave("OD_t_tests.html", inline_css = TRUE,
         path = 'C:/Users/vissa/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_all/OD/'
  )
