...
plots_scatter <- subs_df_VAS %>%
  ...
  labs(x="Orientation dispersion (OD) at 0 weeks",y = "Change in craving VAS after rTMS")+
...
plots_scatter
ggsave(plots_scatter, file='C:/Users/vissa/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_all/ROIs_new/OD/corr_predict_response/OD_predict_deltaresponse_VAS.png', width = 1366/72, height = 768/72, dpi = 72)
...
plots_scatter <- subs_df_CCQ_N %>%
  ...
  ggplot(aes(x=val,y=delta_T,fill=rTMS)) + 
  #geom_violin(trim=FALSE) +
  labs(x="Orientation dispersion (OD) at 0 weeks",y = "Change in craving CCQnow after rTMS")+
  geom_point(shape = 21,stroke = 1,colour = "black",aes(colour = rTMS))+
  geom_smooth(method = lm,aes(colour = rTMS)) +
  xlim(.125,.625) +
  ylim(-125,100) +
  ...
  facet_wrap(~atlas, scale="free")
plots_scatter
ggsave(plots_scatter, file='C:/Users/vissa/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_all/ROIs_new/OD/corr_predict_response/OD_predict_deltaresponse_CCQnow.png', width = 1366/72, height = 768/72, dpi = 72)
...
plots_scatter <- subs_df_BIS %>%
  ...
  ggplot(aes(x=val,y=delta_T,fill=rTMS)) + 
  #geom_violin(trim=FALSE) +
  labs(x="Orientation dispersion (OD) at 0 weeks",y = "Change in total BIS11 after rTMS")+
  geom_point(shape = 21,stroke = 1,colour = "black",aes(colour = rTMS))+
  geom_smooth(method = lm,aes(colour = rTMS)) +
  xlim(.125,.625) +
  ylim(-50,30) +
  ...
  facet_wrap(~atlas, scale="free")
plots_scatter
ggsave(plots_scatter, file='C:/Users/vissa/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_all/ROIs_new/OD/corr_predict_response/OD_predict_deltaresponse_BIStot.png', width = 1366/72, height = 768/72, dpi = 72)
