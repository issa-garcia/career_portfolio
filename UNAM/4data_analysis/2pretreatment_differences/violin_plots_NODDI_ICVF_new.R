...
saveRDS(subs_df,file = "C:/Users/vissa/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_all/ROIs_new/ICVF/meanICVFinROIs_new.RDS")
...
plots_violin <- ggplot(subs_df, aes(fill=group,x=atlas,y=val)) + 
  ...
  #geom_jitter() +
  ggtitle("Neurite density (ICVF): sham and active groups at 0 weeks") +
...
plots_violin
ggsave(plots_violin, file='C:/Users/vissa/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_all/ROIs_new/ICVF/ICVF_WMregions_shamVSactive.png', width = 1366/72, height = 768/72, dpi = 72)
...
gt_tbl <- gt(data = t_tests_tib, auto_align = FALSE) %>%
  tab_header("Neurite density (ICVF): sham and active groups at 0 weeks")
...
gt_tbl %>%
  gtsave("ICVF_t_tests.html", inline_css = TRUE,
         path = 'C:/Users/vissa/Documents/Universitaeten/TEC/Clínicas/2021/UNAM/TMS/postprocess_HARDI/NODDI_all/ROIs_new/ICVF/'
  )
